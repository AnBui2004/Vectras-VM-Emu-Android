...
public class SoftwareStoreHomeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        Glide.with(myHolder.ivIcon).load(current.romIcon).override(180, 180).placeholder(R.drawable.ic_deployed_code_180px_with_padding).error(R.drawable.ic_deployed_code_180px_with_padding).into(myHolder.ivIcon);
