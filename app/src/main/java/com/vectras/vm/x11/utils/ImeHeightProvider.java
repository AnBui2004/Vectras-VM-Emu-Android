...
public class ImeHeightProvider {
    ...
    public static void assistActivity(X11Activity activity) {
    ...
    private static void report(X11Activity activity, FrameLayout content, int bottom, WindowInsetsCompat insets) {
